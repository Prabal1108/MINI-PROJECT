...
function play() {
    ...
    pipe_sprite.forEach((element) => {
      ...
      if (pipe_sprite_props.right <= 0) {
        ...
        if (
          ...
          // Increase the score if player successfully dodges the pipe
          if (
  ...
  function apply_gravity() {
    ...
    // Apply gravity effect on the bird
    bird_dy = bird_dy + gravity;

    // Handle key press for bird jump
    document.addEventListener('keydown', (e) => {
    ...
    // Recalculate bird's properties after moving
    bird_props = bird.getBoundingClientRect();
    ...
    // Continue applying gravity on the next frame
